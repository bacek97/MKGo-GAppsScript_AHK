...
FOR /F "tokens=*" %%a IN ('..\Шаблоны\script\curl.exe -G --data-urlencode "fileName1=%~nx1" --data-urlencode "fileName2=%~nx2" --data-urlencode "folderId=%gfid%" -L "https://script.google.com/macros/s/AKfycbzHCHywgFHS1pMYQYh_HBD0H1tqHKpT54HKP-8OxGoaPnJZ3hA/exec"') DO set "response=%%a"
